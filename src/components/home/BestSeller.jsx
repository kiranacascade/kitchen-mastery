  ...
  return (
    <div className="mx-auto max-w-2xl px-4 sm:py-24 sm:px-6 lg:max-w-7xl lg:px-8">
      ...
      <div className="mt-6 grid grid-cols-1 gap-x-8 gap-y-8 lg:grid-cols-3">
        {products.map((product) => (
          <div key={product.id} className="group relative">
            <div className="aspect-w-4 aspect-h-4 overflow-hidden rounded-md bg-gray-100">
      ...
      <div className="flex items-center justify-center mt-12">
        <a href="/products" className="border border-red-600 py-2 px-4 rounded-md text-lg font-semibold text-gray-900">
          See all products
        </a>
      </div>
    </div>
